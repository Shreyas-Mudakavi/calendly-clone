...
export async function getCalenderEventTimes(
  ...
  const events = await google.calendar("v3").events.list({
    calendarId: "primary", // primary will give you the main calender associated with their email
    eventTypes: ["default"],
    singleEvents: true, // by making this true means that whenever we have a recurring event something that happens every monday, instead of returning on instance it will return every instance
